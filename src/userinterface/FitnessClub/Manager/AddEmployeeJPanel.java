...
public class AddEmployeeJPanel extends javax.swing.JPanel {
     ...
     */
    public AddEmployeeJPanel(JPanel container, FitnessClubEnterprise fitenterprise, Network network) {
        initComponents();
...
//        idTxt.setText(String.valueOf());  //有问题
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(215, 145, 54));
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        if (nameTxt.getText().equals("")) {
            ...
            UserAccount ua = fitenterprise.getUserAccountDirectory().createAnalysisAcount(accountTxt.getText(), CPassField.getText(), new AnalysisRole());
            }
            else{
            UserAccount ua = fitenterprise.getUserAccountDirectory().createTrainerAcount(accountTxt.getText(), CPassField.getText(), new TrainerRole());
            }
            nameTxt.setText("");
